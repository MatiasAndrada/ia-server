...
Documentación completa de endpoints HTTP/HTTPS disponibles en el servidor IA.
...
Gestión de sesiones de WhatsApp vía API HTTP.
...
Para mantener actualización en tiempo real desde frontend, implementa polling:

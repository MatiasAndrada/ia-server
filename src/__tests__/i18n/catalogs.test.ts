...
const ARGS: Record<keyof MessageCatalog, unknown[]> = {
  ...
  reservationSummary: ['__NAME__', 999, '__WHEN__', '__FULLNAME__', '__EVENT__'],
  summaryEditMenu: [],
  ...
  noActiveReservation: [],
  newReservationOverlapReminder: ['__WHEN__', '__CODE__', '__STATUS__'],
  cancelTargetNotFound: [true],
  reservationCancelledInline: ['__WHEN__', '__CODE__'],
  cancelActionFailed: [],
  noActiveReservationsShort: [],
  ...
  reservationConfirmedNotice: ['__NAME__', 999, '__CODE__', 60, '__EVENT__', true],
  reservationRegisteredNotice: ['__NAME__', 999, '__CODE__', '__EVENT__'],
